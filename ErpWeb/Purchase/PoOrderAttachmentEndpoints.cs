...
public static class PoOrderAttachmentEndpoints
{
    public static IEndpointRouteBuilder MapPoOrderAttachmentEndpoints(this IEndpointRouteBuilder endpoints)
    {
        var group = endpoints.MapGroup("/purchase/orders/attachments")
    ...
    private static async Task<IResult> ListAsync(
        string docId,
        [FromServices] IPoOrderAttachmentService attachments,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Results.Ok(new { message = "Expired PO draft attachments cleaned." });
    }
