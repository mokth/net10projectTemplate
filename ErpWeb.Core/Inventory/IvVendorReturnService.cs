...
public sealed class IvVendorReturnService : IIvVendorReturnService
{
    ...
    private readonly ILogger<IvVendorReturnService> _logger;

    public IvVendorReturnService(
        ...
        ILogger<IvVendorReturnService> logger)
    {
    ...
    public async Task<IvVendorReturnOperationResult> PeekNextBatchNoAsync(
        CancellationToken cancellationToken = default)
    {
        var context = ValidateUserContext();
        if (context.Error is not null)
        {
            return IvVendorReturnOperationResult.Fail(context.Error);
        }

        if (!await _accessRights.CanAsync(MenuCodes.InventoryVendorReturn, PermissionCodes.Access, cancellationToken))
        {
            return IvVendorReturnOperationResult.Fail("Not authorized.");
        }
        ...
        return IvVendorReturnOperationResult.OkPeek(peek);
    }

    public async Task<IvVendorReturnOperationResult> GetLookupsAsync(
        CancellationToken cancellationToken = default)
    {
        var context = ValidateUserContext();
        if (context.Error is not null)
        ...
        return IvVendorReturnOperationResult.OkLookups(
    ...
    public async Task<IvVendorReturnOperationResult> SearchAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        query ??= new IvVendorReturnListQuery();
        await using var db = await _dbFactory.CreateDbContextAsync(cancellationToken);
        ...
        return IvVendorReturnOperationResult.OkList(new IvVendorReturnListPage
        {
            Rows = rows.Select(x => new IvVendorReturnListRow
            {
                Id = x.Id,
                BatchNo = x.BatchNo,
                TrxDate = x.TrxDtTime,
    ...
    public async Task<IvVendorReturnOperationResult> GetAsync(
        int batchNo,
        CancellationToken cancellationToken = default)
    {
        var context = ValidateUserContext();
        ...
        if (batchNo <= 0)
        {
            return IvVendorReturnOperationResult.Fail("Batch number is required.");
        }
        ...
        if (batch is null
            || !string.Equals(batch.TrxType, IvTrxTypes.VendorReturn, StringComparison.OrdinalIgnoreCase))
        {
        ...
        var lines = batch.Details
            ...
            .Select(d =>
            {
                ...
                return new IvVendorReturnLineDto
                {
                    LineNo = d.TrxLineNo,
        ...
        return IvVendorReturnOperationResult.OkDocument(new IvVendorReturnDocument
        {
            Id = batch.Id,
    ...
    public async Task<IvVendorReturnOperationResult> SaveNewAsync(
        IvVendorReturnSaveRequest? request,
        CancellationToken cancellationToken = default)
    {
        if (request is null)
        {
            return IvVendorReturnOperationResult.Fail("Save request is required.");
        }
        ...
        if (!await _accessRights.CanAsync(MenuCodes.InventoryVendorReturn, PermissionCodes.Add, cancellationToken))
        {
            return IvVendorReturnOperationResult.Fail("Not authorized.");
        }
        ...
        {
            return IvVendorReturnOperationResult.Fail(validatedResult.ErrorMessage);
        }
        ...
        _logger.LogInformation(
            "Vendor return saved. UserId={UserId} CompanyCode={CompanyCode} BranchCode={BranchCode} BatchNo={BatchNo} Lines={LineCount}",
            context.UserId,
            context.CompanyCode,
            context.BranchCode,
            batchNo,
        ...
        return IvVendorReturnOperationResult.OkSaved(batch.Id, batchNo);
    }

    public async Task<IvVendorReturnOperationResult> UpdateAsync(
        int batchNo,
        IvVendorReturnSaveRequest? request,
        CancellationToken cancellationToken = default)
    {
        ...
        if (!await _accessRights.CanAsync(MenuCodes.InventoryVendorReturn, PermissionCodes.Edit, cancellationToken))
        {
            return IvVendorReturnOperationResult.Fail("Not authorized.");
        }
        ...
        _logger.LogInformation(
            "Vendor return updated. UserId={UserId} CompanyCode={CompanyCode} BranchCode={BranchCode} BatchNo={BatchNo} Lines={LineCount}",
            context.UserId,
            context.CompanyCode,
            context.BranchCode,
            batch.BatchNo,
        ...
        return IvVendorReturnOperationResult.OkSaved(batch.Id, batch.BatchNo);
    }

    public async Task<IvVendorReturnOperationResult> DeleteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!await _accessRights.CanAsync(MenuCodes.InventoryVendorReturn, PermissionCodes.Delete, cancellationToken))
        {
            return IvVendorReturnOperationResult.Fail("Not authorized.");
        }
        ...
        if (nos.Count == 0)
        {
            return IvVendorReturnOperationResult.Fail("Select at least one Vendor return.");
        }
        ...
        foreach (var no in nos)
        {
            ...
            if (!string.Equals(batch.BatchStatus, IvBatchStatuses.New, StringComparison.OrdinalIgnoreCase))
            {
                return IvVendorReturnOperationResult.Fail(
                    $"Vendor return {no} cannot be deleted because it is not NEW.");
            }
        ...
        _logger.LogInformation(
            "Vendor return(s) deleted. UserId={UserId} CompanyCode={CompanyCode} BranchCode={BranchCode} Count={Count}",
            context.UserId,
            context.CompanyCode,
            context.BranchCode,
            nos.Count);

        return IvVendorReturnOperationResult.Ok();
    }

    public async Task<IvVendorReturnOperationResult> CancelAsync(
        IReadOnlyList<int>? batchNos,
        CancellationToken cancellationToken = default)
    {
        var context = ValidateWriteContext();
        ...
        if (!await _accessRights.CanAsync(MenuCodes.InventoryVendorReturn, PermissionCodes.Cancel, cancellationToken))
        {
            return IvVendorReturnOperationResult.Fail("Not authorized.");
        }
        ...
        foreach (var no in nos)
        {
            ...
            {
                return IvVendorReturnOperationResult.Fail(
                    $"Vendor return {no} cannot be cancelled because it is not NEW.");
            }
        ...
        _logger.LogInformation(
            "Vendor return(s) cancelled. UserId={UserId} CompanyCode={CompanyCode} BranchCode={BranchCode} Count={Count}",
            context.UserId,
            context.CompanyCode,
            context.BranchCode,
            nos.Count);
    ...
    public async Task<IvVendorReturnOperationResult> PostAsync(
        IReadOnlyList<int> batchNos,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<IvVendorReturnOperationResult> RollbackAsync(
        IReadOnlyList<int> batchNos,
        CancellationToken cancellationToken = default)
    {
    ...
    private async Task<(string? ErrorMessage, List<ValidatedLine>? Lines)> ValidateLinesAsync(
        AppDbContext db,
        IReadOnlyList<IvVendorReturnLineRequest>? lines,
        string companyCode,
        string branchCode,
        CancellationToken cancellationToken)
    {
        ...
        {
            return ("Add at least one vendor return line.", null);
        }

        if (lines.Count > short.MaxValue)
        {
            return ("Too many vendor return lines.", null);
        }
        ...
        int batchNo)
    {
        ...
        foreach (var row in validated)
        {
            batch.Details.Add(new IvTrxBatchDetail
            {
                ...
                FrStdUom = row.Uom,
                FrPurQty = IvQty.Round(row.Quantity),
                FromLotId = null,
                IStatus = row.IStatus,
    ...
    private async Task<(string? ErrorMessage, ValidatedLine? Line)> ValidateLineAsync(
        AppDbContext db,
        IvVendorReturnLineRequest line,
        string companyCode,
        string branchCode,
        short lineNo,
        CancellationToken cancellationToken)
    {
        ...
        if ((poLine.OneTime ?? po.OneTime) == true)
        {
            return ($"Line {lineNo}: one-time / non-stock PO lines cannot be vendor-returned.", null);
        }
        ...
        if (!string.Equals(poLine.ICode ?? string.Empty, iCode, StringComparison.OrdinalIgnoreCase))
        {
            return ($"Line {lineNo}: item '{iCode}' does not match PO line item '{poLine.ICode}'.", null);
        }
        ...
        if (PoOrderCalc.IsServiceIType(item.IType))
        {
            return ($"Line {lineNo}: service items cannot be vendor-returned.", null);
        }

        if (!item.StockControl)
        {
            return ($"Line {lineNo}: item '{iCode}' is not stock-controlled and cannot be vendor-returned.", null);
        }
