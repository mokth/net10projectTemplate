...
public sealed class IvStockReturnService : IIvStockReturnService
{
    ...
    private readonly ILogger<IvStockReturnService> _logger;

    public IvStockReturnService(
        ...
        ILogger<IvStockReturnService> logger)
    {
    ...
    public async Task<IvStockReturnOperationResult> PeekNextBatchNoAsync(
        CancellationToken cancellationToken = default)
    {
        ...
        if (!await _accessRights.CanAsync(MenuCodes.InventoryStockReturn, PermissionCodes.Access, cancellationToken))
        {
            return IvStockReturnOperationResult.Fail("Not authorized.");
        }
        ...
        return IvStockReturnOperationResult.OkPeek(peek);
    }

    public async Task<IvStockReturnOperationResult> GetLookupsAsync(
        CancellationToken cancellationToken = default)
    {
        var context = ValidateUserContext();
        if (context.Error is not null)
        ...
        return IvStockReturnOperationResult.OkLookups(
    ...
    public async Task<IvStockReturnOperationResult> SearchAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        query ??= new IvStockReturnListQuery();
        await using var db = await _dbFactory.CreateDbContextAsync(cancellationToken);
        ...
        return IvStockReturnOperationResult.OkList(new IvStockReturnListPage
        {
            Rows = rows.Select(x => new IvStockReturnListRow
            {
                Id = x.Id,
                BatchNo = x.BatchNo,
                TrxDate = x.TrxDtTime,
    ...
    public async Task<IvStockReturnOperationResult> GetAsync(
        int batchNo,
        CancellationToken cancellationToken = default)
    {
        var context = ValidateUserContext();
        ...
        if (batchNo <= 0)
        {
            return IvStockReturnOperationResult.Fail("Batch number is required.");
        }
        ...
        if (batch is null
            || !string.Equals(batch.TrxType, IvTrxTypes.CustomerReturn, StringComparison.OrdinalIgnoreCase))
        {
        ...
        var lines = batch.Details
            ...
            .Select(d =>
            {
                ...
                var (reason, remarks) = ParseStoredRemarks(d.Remarks);
                return new IvStockReturnLineDto
                {
                    LineNo = d.TrxLineNo,
                    ICode = code,
                    IDesc = d.IDesc,
        ...
        return IvStockReturnOperationResult.OkDocument(new IvStockReturnDocument
        {
            Id = batch.Id,
    ...
    public async Task<IvStockReturnOperationResult> SaveNewAsync(
        IvStockReturnSaveRequest? request,
        CancellationToken cancellationToken = default)
    {
        if (request is null)
        {
            return IvStockReturnOperationResult.Fail("Save request is required.");
        }
        ...
        if (!await _accessRights.CanAsync(MenuCodes.InventoryStockReturn, PermissionCodes.Add, cancellationToken))
        {
            return IvStockReturnOperationResult.Fail("Not authorized.");
        }
        ...
        {
            return IvStockReturnOperationResult.Fail(validatedResult.ErrorMessage);
        }
        ...
        _logger.LogInformation(
            "Stock return saved. UserId={UserId} CompanyCode={CompanyCode} BranchCode={BranchCode} BatchNo={BatchNo} Lines={LineCount}",
            context.UserId,
            context.CompanyCode,
            context.BranchCode,
            batchNo,
        ...
        return IvStockReturnOperationResult.OkSaved(batch.Id, batchNo);
    }

    public async Task<IvStockReturnOperationResult> UpdateAsync(
        int batchNo,
        IvStockReturnSaveRequest? request,
        CancellationToken cancellationToken = default)
    {
        ...
        if (!await _accessRights.CanAsync(MenuCodes.InventoryStockReturn, PermissionCodes.Edit, cancellationToken))
        {
            return IvStockReturnOperationResult.Fail("Not authorized.");
        }
        ...
        _logger.LogInformation(
            "Stock return updated. UserId={UserId} CompanyCode={CompanyCode} BranchCode={BranchCode} BatchNo={BatchNo} Lines={LineCount}",
            context.UserId,
            context.CompanyCode,
            context.BranchCode,
            batch.BatchNo,
        ...
        return IvStockReturnOperationResult.OkSaved(batch.Id, batch.BatchNo);
    }

    public async Task<IvStockReturnOperationResult> DeleteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!await _accessRights.CanAsync(MenuCodes.InventoryStockReturn, PermissionCodes.Delete, cancellationToken))
        {
            return IvStockReturnOperationResult.Fail("Not authorized.");
        }
        ...
        if (nos.Count == 0)
        {
            return IvStockReturnOperationResult.Fail("Select at least one stock return.");
        }
        ...
        _logger.LogInformation(
            "Stock return(s) deleted. UserId={UserId} CompanyCode={CompanyCode} BranchCode={BranchCode} Count={Count}",
            context.UserId,
            context.CompanyCode,
            context.BranchCode,
            nos.Count);

        return IvStockReturnOperationResult.Ok();
    }

    public async Task<IvStockReturnOperationResult> PostAsync(
        IReadOnlyList<int> batchNos,
        CancellationToken cancellationToken = default)
    {
        var posting = await _posting.PostAsync(IvTrxTypes.CustomerReturn, batchNos, cancellationToken);
        return IvStockReturnOperationResult.OkPosting(posting);
    }

    public async Task<IvStockReturnOperationResult> RollbackAsync(
        IReadOnlyList<int> batchNos,
        CancellationToken cancellationToken = default)
    {
        var posting = await _posting.RollbackAsync(IvTrxTypes.CustomerReturn, batchNos, cancellationToken);
        return IvStockReturnOperationResult.OkPosting(posting);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return ("Add at least one return line.", null);
        }

        if (lines.Count > short.MaxValue)
        {
            return ("Too many return lines.", null);
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var uom = (item.StdUom ?? string.Empty).Trim();
    ...
    private static string? NormalizeReasonCode(string? reason)
    {
        ...
        return IvReturnReasons.All.FirstOrDefault(c =>
    ...
    internal static (string? Reason, string? Remarks) ParseStoredRemarks(string? stored)
    {
        ...
        foreach (var code in IvReturnReasons.All)
        {
