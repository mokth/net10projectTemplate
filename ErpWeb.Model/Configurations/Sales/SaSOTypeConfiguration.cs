...
public class SaSOTypeConfiguration : IEntityTypeConfiguration<SaSOType>
{
    public void Configure(EntityTypeBuilder<SaSOType> builder)
    {
        builder.ToTable("SaSOType");
        builder.HasKey(e => new { e.CompanyCode, e.SOTypeCode });

        builder.Property(e => e.CompanyCode).HasMaxLength(10).IsRequired();
        builder.Property(e => e.SOTypeCode).HasMaxLength(20).IsRequired();
        builder.Property(e => e.SOTypeDesc).HasMaxLength(100);
