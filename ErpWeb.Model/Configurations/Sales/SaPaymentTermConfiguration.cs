...
public class SaPaymentTermConfiguration : IEntityTypeConfiguration<SaPaymentTerm>
{
    public void Configure(EntityTypeBuilder<SaPaymentTerm> builder)
    {
        builder.ToTable("SaPaymentTerm");
        builder.HasKey(e => new { e.CompanyCode, e.PayCode });

        builder.Property(e => e.CompanyCode).HasMaxLength(10).IsRequired();
        builder.Property(e => e.PayCode).HasMaxLength(20).IsRequired();
        builder.Property(e => e.PayDesc).HasMaxLength(100);
