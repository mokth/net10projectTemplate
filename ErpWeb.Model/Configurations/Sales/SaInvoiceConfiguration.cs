...
public class SaInvoiceConfiguration : IEntityTypeConfiguration<SaInvoice>
{
    public void Configure(EntityTypeBuilder<SaInvoice> builder)
    {
        ...
        builder.Property(e => e.ArGlCode).HasMaxLength(20);
        builder.Property(e => e.InvEmail).HasMaxLength(100);
        builder.Property(e => e.BuyerTin).HasMaxLength(20);
        builder.Property(e => e.BuyerBrn).HasMaxLength(50);
        builder.Property(e => e.BuyerRegType).HasMaxLength(20);
        builder.Property(e => e.GstregNo).HasMaxLength(50);
