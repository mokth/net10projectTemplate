...
public class SaCommentConfiguration : IEntityTypeConfiguration<SaComment>
{
    public void Configure(EntityTypeBuilder<SaComment> builder)
    {
        builder.ToTable("SaComment");
        builder.HasKey(e => new { e.CompanyCode, e.CommID });

        builder.Property(e => e.CompanyCode).HasMaxLength(10).IsRequired();
        builder.Property(e => e.CommID).HasMaxLength(20).IsRequired();
