...
public class SaQtDetailConfiguration : IEntityTypeConfiguration<SaQtDetail>
{
    public void Configure(EntityTypeBuilder<SaQtDetail> builder)
    {
        builder.ToTable("SaQTDetail");
        builder.HasKey(e => new { e.CompanyCode, e.BranchCode, e.QtNo, e.CustRel, e.Line });
        ...
        builder.Property(e => e.ConvertedQty).HasPrecision(18, 4);
