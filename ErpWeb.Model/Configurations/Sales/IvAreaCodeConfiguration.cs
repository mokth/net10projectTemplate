...
public class IvAreaCodeConfiguration : IEntityTypeConfiguration<IvAreaCode>
{
    public void Configure(EntityTypeBuilder<IvAreaCode> builder)
    {
        builder.ToTable("IvAreaCode");
        builder.HasKey(e => new { e.CompanyCode, e.AreaCode });

        builder.Property(e => e.CompanyCode).HasMaxLength(10).IsRequired();
        builder.Property(e => e.AreaCode).HasMaxLength(40).IsRequired();
        builder.Property(e => e.AreaDesc).HasMaxLength(200);
        ...
        builder.Property(e => e.Latitude).HasColumnName("latitude").HasMaxLength(50);
        builder.Property(e => e.Longitude).HasColumnName("longitude").HasMaxLength(50);
    }
}
