...
public class SaCustTypeConfiguration : IEntityTypeConfiguration<SaCustType>
{
    public void Configure(EntityTypeBuilder<SaCustType> builder)
    {
        builder.ToTable("SaCustType");
        builder.HasKey(e => new { e.CompanyCode, e.CustTypeCode });

        builder.Property(e => e.CompanyCode).HasMaxLength(10).IsRequired();
        builder.Property(e => e.CustTypeCode).HasMaxLength(40).IsRequired();
        builder.Property(e => e.CustTypeDesc).HasMaxLength(200);
