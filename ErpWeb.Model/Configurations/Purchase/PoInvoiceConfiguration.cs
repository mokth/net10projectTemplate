...
public class PoInvoiceConfiguration : IEntityTypeConfiguration<PoInvoice>
{
    public void Configure(EntityTypeBuilder<PoInvoice> builder)
    {
        ...
        builder.HasIndex(e => new { e.CompanyCode, e.BranchCode, e.Status, e.DocDate })
            .HasDatabaseName("IX_POCDN_Company_Branch_Status_DocDate");

        builder.HasIndex(e => new { e.CompanyCode, e.BranchCode, e.Type, e.Status })
            .HasDatabaseName("IX_POCDN_Company_Branch_Type_Status");
