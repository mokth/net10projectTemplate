...
namespace EInvoiceAPI.Utility
{
    public class HashUtility
    {
        ...
        public static T DeSerializeJson<T>(string content)
        {
            ...
            var jsonString = JsonConvert.DeserializeObject<T>(content, settings);

            return jsonString;
        }

        public static T DeserializeXmlFileToClass<T>(string filePath)
        {
        ...
        public static T DeserializeXmlStringToClass<T>(string xmlstring)
        {
            XmlSerializer serializer = new XmlSerializer(typeof(T));
            ...
            {
                return (T)serializer.Deserialize(strem);
            }
        }
