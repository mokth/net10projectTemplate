...
Primary sources:
- [ERP/SalesForms/InvoiceEntry.aspx](ERP/SalesForms/InvoiceEntry.aspx) — UI, client validation, callbacks
- [ERP/SalesForms/InvoiceEntry.aspx.cs](ERP/SalesForms/InvoiceEntry.aspx.cs) — entry orchestration
- [ERP/SalesForms/InvView.aspx.cs](ERP/SalesForms/InvView.aspx.cs) — listing edit/delete/post gates
- [ERPClasses/BL/InvoiceBL.cs](ERPClasses/BL/InvoiceBL.cs) — credit, totals, GL check
- [ERPCommonUI/SalesForms/HelperClass/ShipmentHelper.cs](ERPCommonUI/SalesForms/HelperClass/ShipmentHelper.cs) — Add Shipment
- [ERPCommonUI/SalesForms/Controls/SPShipment.ascx.cs](ERPCommonUI/SalesForms/Controls/SPShipment.ascx.cs) — Edit Shipment
- [ERPCommonUI/SalesForms/HelperClass/SPBatchNoHelper.cs](ERPCommonUI/SalesForms/HelperClass/SPBatchNoHelper.cs) — batch number
- [ERPCommonUI/SalesForms/HelperClass/SalesDicountHelper.cs](ERPCommonUI/SalesForms/HelperClass/SalesDicountHelper.cs) — discount
- [ERPCommonUI/SalesForms/HelperClass/SalesCommonHelper.cs](ERPCommonUI/SalesForms/HelperClass/SalesCommonHelper.cs) — credit/term + bypass
- [ERPCommonUI/SalesForms/HelperClass/InvTrxHelper.cs](ERPCommonUI/SalesForms/HelperClass/InvTrxHelper.cs) — delete + post
- [ERPCommonUI/Helper/NeedPostHelper.cs](ERPCommonUI/Helper/NeedPostHelper.cs) — post after save
- Page ID for rights: `200.3.2`
